    ...
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
      ...
      >
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            <tr className='hover:bg-green-200  bg-white hover:cursor-pointer '>
              ...
              <td
                class="px-5 py-5 border-b border-gray-200  text-sm text-right"
              >
                <button
                  type="button"
            ...
            <tr className='border-t hover:bg-green-200 bg-white hover:cursor-pointer  '>
              <td class="px-5 py-5  border-b border-gray-200  text-sm">
                <div class="flex">
                  <div class="flex-shrink-0 w-10 h-10">
                    <img
            ...
            <tr  className='hover:bg-green-200 hover:cursor-pointer bg-white '>
              <td class="px-5 py-5 border-b border-gray-200  text-sm">
                <div class="flex">
                  <div class="flex-shrink-0 w-10 h-10">
                    <img
