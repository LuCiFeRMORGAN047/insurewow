...
const Contactus = () => {
    ...
    return ( 
        <div className="h-[100vh] pt-[5rem] flex mb-[3rem] pl-[8rem] pr-[8rem]">
            
            <div className="flex-1 p-3 pl-[6rem]">
              <h2 className="mt-[5rem] pl-[7rem]  font-bold text-blue-950 tracking-widest text-3xl ">GET IN TOUCH</h2>  
            ...
            <form onSubmit={HandleSubmit}>
                ...
                <button type="submit" className='active:scale-[0.99] font-light tracking-wide text-white bg-emerald-500 rounded-xl   p-2 w-[30.8rem] mt-[2rem]'>
                 Send
                </button>
            </form>
            </div>
            <div className="flex-1">
                <img src={va} alt="virtual assistant" />
            </div>
        </div>
     );
}
